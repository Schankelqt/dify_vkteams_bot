...
schedule.every().thursday.at("10:00").do(job_send_questions, team_id=1, key="daily_regular")
...
schedule.every().thursday.at("10:30").do(job_send_report, team_id=1)
...
schedule.every().tuesday.at("09:00").do(job_send_questions, team_id=2, key="daily_regular")
...
# Команда 3 (Weekly)
schedule.every().wednesday.at("12:00").do(job_send_questions, team_id=3, key="weekly")
schedule.every().wednesday.at("23:55").do(job_send_report, team_id=3)

# Команда 4 (Weekly)
schedule.every().thursday.at("09:00").do(job_send_questions, team_id=4, key="weekly")
