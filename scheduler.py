...
schedule.every().wednesday.at("09:25").do(job_send_questions, team_id=1, key="daily_regular")
...
schedule.every().wednesday.at("10:00").do(job_send_report, team_id=1)
...
schedule.every().wednesday.at("09:25").do(job_send_questions, team_id=2, key="daily_regular")
